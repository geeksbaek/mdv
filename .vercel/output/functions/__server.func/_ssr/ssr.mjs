...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Be0kMZ8D.mjs");
...
var manifest = {
	"50016a4edde0778a1f0cadbddb8e9a37d3998979b490f832e1ff9ef94bd727a5": {
		functionName: "getShare_createServerFn_handler",
		importer: () => import("./share-api-ClDeMq0A.mjs")
	},
	"9417dd112327904f10719e0d2a09b21702354343caeda33bb1f3e17454e5fec3": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DORzhVoT.mjs").then((n) => n.t),
